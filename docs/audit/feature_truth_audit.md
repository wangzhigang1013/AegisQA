...
| Trace | Trace Tree/Flow、Step 详情 | `/tasks/{task_id}/trace-*` | Run item/step | 是，来自 RunItemStep | 不直接阻断，用于定位和 Replay | 后端、前端、E2E | 旧 Run 缺字段时降级展示 | 保留主流程 | 完善 Repro Bundle 与 Replay 的真实使用体验 |
...
3. 完善 Replay、Prompt Debug、Repro Bundle 的任务级 E2E。
